...
import { PlayCircle, ArrowRight, Building2, MessageSquare } from 'lucide-react';
        ...
        <div className="card-proptech p-10 sm:p-16 bg-[#102A43] text-white text-center space-y-6 shadow-elevated relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <span className="text-xs font-bold text-[#75CFC3] uppercase tracking-wider bg-white/10 px-3.5 py-1.5 rounded-full border border-white/15">
              {lang === 'ro' ? 'Tranziția la Noul Standard de Administrare' : 'Upgrade to the Modern Standard'}
            </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              ...
              <span>{lang === 'ro' ? 'Lansează Demo Interactiv' : 'Launch Interactive Demo'}</span>
            </Link>
            ...
            >
              ...
              <span>{lang === 'ro' ? 'Înscrie clădirea în pilot' : 'Enroll Building in Pilot'}</span>
            </Link>
          </div>
