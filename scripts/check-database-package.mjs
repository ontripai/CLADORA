...
const failures = [];
if (migrations.length !== 45) failures.push(`expected 45 migrations, found ${migrations.length}`);
if (tests.length !== 33) failures.push(`expected 33 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 706) failures.push(`expected 706 assertions, found ${assertionTotal}`);
