...
const failures = [];
if (migrations.length !== 44) failures.push(`expected 44 migrations, found ${migrations.length}`);
if (tests.length !== 32) failures.push(`expected 32 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 683) failures.push(`expected 683 assertions, found ${assertionTotal}`);
