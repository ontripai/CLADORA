...
if (tests.length !== 13) failures.push(`expected 13 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 270) failures.push(`expected 270 assertions, found ${assertionTotal}`);
