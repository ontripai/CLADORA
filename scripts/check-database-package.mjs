...
const failures = [];
if (migrations.length !== 27) failures.push(`expected 27 migrations, found ${migrations.length}`);
if (tests.length !== 15) failures.push(`expected 15 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 370) failures.push(`expected 370 assertions, found ${assertionTotal}`);
