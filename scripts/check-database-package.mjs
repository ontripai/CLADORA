...
const failures = [];
if (migrations.length !== 26) failures.push(`expected 26 migrations, found ${migrations.length}`);
if (tests.length !== 14) failures.push(`expected 14 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 324) failures.push(`expected 324 assertions, found ${assertionTotal}`);
