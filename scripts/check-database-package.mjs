...
const failures = [];
if (migrations.length !== 43) failures.push(`expected 43 migrations, found ${migrations.length}`);
if (tests.length !== 31) failures.push(`expected 31 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 660) failures.push(`expected 660 assertions, found ${assertionTotal}`);
