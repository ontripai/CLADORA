...
const failures = [];
if (migrations.length !== 28) failures.push(`expected 28 migrations, found ${migrations.length}`);
if (tests.length !== 16) failures.push(`expected 16 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 406) failures.push(`expected 406 assertions, found ${assertionTotal}`);
