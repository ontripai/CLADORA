...
const failures = [];
if (migrations.length !== 37) failures.push(`expected 37 migrations, found ${migrations.length}`);
if (tests.length !== 25) failures.push(`expected 25 pgTAP files, found ${tests.length}`);
...
if (assertionTotal !== 524) failures.push(`expected 524 assertions, found ${assertionTotal}`);
